                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          alignment: Alignment.centerLeft,
                          child: Text(
                            "Você entregou as:  ${format.format(DateTime.fromMillisecondsSinceEpoch(pedido.deliveredAt!.millisecondsSinceEpoch).toLocal()) ?? ""}",
                            style: TextStyle(
                                fontFamily: "Brand-Regular",
                                fontSize: 16.0,
                                color: Colors.white70),
                    ...
                    children: [
                      Row(children: [
                        ...
                        FloatingActionButton(
                            ...
                            onPressed: () {
                              launchGoogleMaps(double.parse(order.lat_ponto),
                                  double.parse(order.long_ponto));
                            },
                            child: Icon(
                              Icons.navigation,
                              color: Colors.white,
